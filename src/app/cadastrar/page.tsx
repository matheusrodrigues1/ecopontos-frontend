...
const Cadastrar = () => {
  return (
    <div className="flex flex-col justify-center items-center w-screen h-screen pb-20 bg-white">
      <span className="font-bold">Cadastrar informações</span>
      <div className="flex flex-col items-center justify-center">
        <form className="flex flex-col gap-2 w-[340px]">
          <div>
            <label className="block text-[10px] text-[#093A3E] font-bold mb-1">
              Titulo
            </label>
            <input
              type="text"
              placeholder="Ecoponto Nome 1"
              className="w-full h-[35px] border-2 !bg-[#093A3E] !text-white !placeholder:text-[20px] border-[#093A3E] p-3 !rounded-lg !pl-3"
            />
          </div>
          <div>
            <label className="block text-[10px] text-[#093A3E] font-bold mb-1">
